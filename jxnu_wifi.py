...
init_url="http://10.51.3.40"
get_challenge_api="http://10.51.3.40/cgi-bin/get_challenge"

srun_portal_api="http://10.51.3.40/cgi-bin/srun_portal"
get_info_api="http://10.51.3.40/cgi-bin/rad_user_info?callback=jQuery112406118340540763985_1556004912581&_=1556004912582"
n = '200'
type = '1'
ac_id='2'
enc = "srun_bx1"
...
def init_getip():
	...
	ip=re.search('(([1-9])|(1\d\d?)|(2[0-4]?\d)|(25[0-5]))\.'
    '(((1?\d?\d)|(2[0-4]?\d)|(25[0-5]))\.){2}'     
    '((25[0-5])|(2[0-4]\d)|(1?\d?\d))',init_res.text).group(0)
	print("ip:"+ip)
def get_token():
	# print("获取token")
	global token
